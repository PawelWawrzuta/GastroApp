...
namespace GastroApp.Migrations
{
    ...
    [Migration("20221223080538_AddListaZamowieniaToDb")]
    partial class AddListaZamowieniaToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GastroApp.Models.Zamowienia.Klient", b =>
                {
                    ...
                    b.Property<string>("DlugoscGeograficzna")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("SzerokoscGeograficzna")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("GastroApp.Models.Zamowienia.ListaZamowienia", b =>
                {
                    b.Property<int>("IdListyZamowienia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdListyZamowienia"), 1L, 1);
                    ...
                    b.HasKey("IdListyZamowienia");

                    b.HasIndex("IdProduktu");

                    b.HasIndex("IdZamowienia");

                    b.ToTable("ListaZamowienia");
                });
            ...
            modelBuilder.Entity("GastroApp.Models.Zamowienia.Status", b =>
                {
            ...
            modelBuilder.Entity("GastroApp.Models.Zamowienia.Zamowienie", b =>
                {
                    b.Property<int>("IdZamowienia")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdZamowienia"), 1L, 1);

                    b.Property<DateTime>("DataOne")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("DataTwo")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("GastroApp.Models.Zamowienia.ListaZamowienia", b =>
                {
                    b.HasOne("GastroApp.Models.Produkt", "Produkt")
                        .WithMany()
                        .HasForeignKey("IdProduktu")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GastroApp.Models.Zamowienia.Zamowienie", "Zamowienie")
                        .WithMany()
            ...
            modelBuilder.Entity("GastroApp.Models.Zamowienia.Zamowienie", b =>
                {
                    b.HasOne("GastroApp.Models.Zamowienia.Klient", "Klient")
                        .WithMany()
                    ...
                    b.HasOne("GastroApp.Models.Zamowienia.SposobPlatnosci", "SposobPlatnosci")
                        .WithMany()
                        .HasForeignKey("IdSposobuPlatnosci")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GastroApp.Models.Zamowienia.Status", "Status")
                        .WithMany()
